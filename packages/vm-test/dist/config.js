...
module.exports = {
  install: function install(Vue, options) {
    ...
    config.init(options.config, options.plt);
  ...
  _createClass(Config, [{
    ...
    value: function get(key) {
      ...
      if (!isDefined(this._c[key])) {
        ...
        var userPlatformValue = undefined; //  config[platforms][platform][key]
        var userDefaultValue = this._s[key]; // config[key]
        var platformValue = undefined; // this.plt._registry[platformName].setting[key]
        var configObj = null;
